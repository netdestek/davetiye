...
export default async function InvitationPage({ params }: PageProps) {
  ...
  const daysLeft = Math.max(
    0,
    Math.ceil((eventDate.getTime() - Date.now()) / 86_400_000),
  );
    ...
    <main className="min-h-screen bg-[#f7f1eb] text-[#332925]">
      ...
      <header className="relative z-10 flex h-16 items-center justify-center">
        <a href="/" className="flex items-center gap-2" aria-label="Davetly">
          <span className="liquid-icon liquid-icon--brand size-8 rounded-xl">
      ...
      <section className="relative z-10 mx-auto max-w-[780px] px-4 pb-16 sm:px-6">
          ...
          <div className="relative aspect-[16/10] min-h-[270px] overflow-hidden sm:aspect-[16/9]">
            {invitation.videoKey ? (
              ...
              <video
                ...
                preload="metadata"
                poster={
                  invitation.posterKey
                    ? `/api/media/${encodeURIComponent(slug)}/poster`
                    : undefined
                }
              >
              ...
              <>
                <img
                  src="/og.png"
                  alt="Davetly dijital davetiye ön izlemesi"
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-9">
                  ...
                  <h1 className="mt-2 font-invitation text-[37px] font-medium italic leading-none tracking-[-0.035em] sm:text-[52px]">
        ...
        <div className="mx-auto -mt-1 max-w-[680px] rounded-b-[28px] border-x border-b border-[#e3d6ce] bg-[#fffdfa] px-5 pb-7 pt-8 text-center shadow-[0_18px_60px_rgba(60,40,34,.08)] sm:px-9">
          <p className="mx-auto max-w-md font-invitation text-[22px] italic leading-8 text-[#56413a]">
          ...
          <div className="grid gap-3 text-left sm:grid-cols-2">
            ...
            <div className="flex items-start gap-3 rounded-2xl bg-[#faf5f1] p-4">
              <span className="liquid-icon liquid-icon--sage size-9 shrink-0 rounded-xl">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-4 inline-flex h-10 items-center gap-2 rounded-xl border border-[#e3d6ce] bg-white px-4 text-xs font-semibold text-[#5f4c46] hover:bg-[#faf6f3]"
          >
        ...
        <div className="my-8 grid grid-cols-[1fr_auto_1fr] items-center gap-4">
          ...
          <div className="text-center">
            <strong className="font-heading text-[32px] font-semibold text-primary">
              {daysLeft}
            </strong>
            <p className="-mt-1 text-[9px] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
              gün kaldı
            </p>
          </div>
          <div className="h-px bg-[#dfd1ca]" />
      ...
      <footer className="relative z-10 border-t border-[#e4d8d1] py-7 text-center text-[11px] text-muted-foreground">
        Sevgiyle hazırlandı ·{' '}
